        ...
        private byte[] CreateParam()
        {
            ...
            switch (Type)
            {
                case (byte)PARA_TYPE.TYPE_PmtGain:
                    ...
                    break;
                case (byte)PARA_TYPE.TYPE_WindowPara:
                    param = new byte[51] {
                        0x02 , 0x08 , 0x00 , 0x00 , 0x00 , 0x08 , 0x00 , 0x00 , 0x00 , 0x0F ,
                        0x00 , 0x00 , 0x00 , 0x75 , 0x00 , 0x00 , 0x00 , 0xDB , 0x00 , 0x00 ,
                        0x00 , 0x00 , 0x00 , 0x70 , 0x42 , 0x00 , 0x00 , 0x70 , 0x42 , 0xDC ,
                        0x0F , 0x49 , 0x40 , 0xDC , 0x0F , 0x49 , 0x40 , 0x00 , 0x19 , 0x00 ,
                        0x00 , 0x00 , 0x19 , 0x00 , 0x00 , 0x08 , 0x00 , 0x08 , 0x00 , 0xF8 ,
                        0x00
                    };
                    break;
